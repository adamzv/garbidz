...
public class V1_2_8__extract_containers_biowaste extends BaseJavaMigration {
    ...
    public void migrate(Context context) throws Exception {
        ...
        InputStream inputStream = classloader.getResourceAsStream("json/biowaste.json");
        try {
            ...
            System.out.println("Unable to save biowaste containers data: " + e.getMessage());
        }
    }
}