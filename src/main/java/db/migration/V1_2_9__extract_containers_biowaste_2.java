...
public class V1_2_9__extract_containers_biowaste_2 extends BaseJavaMigration {
    ...
    public void migrate(Context context) throws Exception {
        ...
        InputStream inputStream = classloader.getResourceAsStream("json/biowaste_2.json");
        try {
            ...
            System.out.println("Unable to save biowaste 2 containers data: " + e.getMessage());
        }
    }
}
