...
public class V1_2_2__extract_containers_mixed_packaging extends BaseJavaMigration {
    ...
    public void migrate(Context context) throws Exception {
        ...
        InputStream inputStream = new FileInputStream("src/main/resources/db/json/mixed_packaging.json");
        try {
            ...
            System.out.println("Unable to save mixed packaging containers data: " + e.getMessage());
        }
    }
}
