...
public class V1_2_0__extract_containers_paper_cardboard extends BaseJavaMigration {
    ...
    public void migrate(Context context) throws Exception {
        ...
        try {
            ...
            System.out.println("Unable to save paper and cardboard containers data: " + e.getMessage());
        }
    }
}
