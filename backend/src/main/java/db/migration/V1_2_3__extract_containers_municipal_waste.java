...
public class V1_2_3__extract_containers_municipal_waste extends BaseJavaMigration {
    ...
    public void migrate(Context context) throws Exception {
        ...
        InputStream inputStream = new FileInputStream("src/main/resources/db/json/municipal_waste.json");
        try {
            ...
            System.out.println("Unable to save municipal waste containers data: " + e.getMessage());
        }
    }
}
